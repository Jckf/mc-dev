      ...
      if(!this.a) {
         ...
         while(var21.hasNext()) {
            ...
            if(var12.length() > var1.length() && var12.startsWith(var1) && var12.indexOf(".", var1.length() + 1) < 0) {
               ...
               var7.add(new qj(var19, var15, var17));
            }
         }
         ...
         if((float)var8 > var20) {
            var7.add(new qj("unspecified", (double)((float)var8 - var20) * 100.0D / (double)var8, (double)((float)var8 - var20) * 100.0D / (double)var3));
         }

         Collections.sort(var7);
         var7.add(0, new qj(var1, 100.0D, (double)var8 * 100.0D / (double)var3));
         return var7;
      }
   }
