...
public class b {
   ...
   private void h() {
      ...
      this.d.a("AABB Pool Size", (Callable)(new i(this)));
      this.d.a("IntCache", (Callable)(new j(this)));
   }
   ...
   public void a(StringBuilder var1) {
      if((this.h == null || this.h.length <= 0) && this.e.size() > 0) {
         this.h = (StackTraceElement[])ArrayUtils.subarray((Object[])((k)this.e.get(0)).a(), 0, 1);
      }
   ...
   public k a(String var1, int var2) {
      k var3 = new k(this, var1);
      if(this.g) {
         ...
         if(var4 > 0 && !this.e.isEmpty()) {
            k var9 = (k)this.e.get(this.e.size() - 1);
            var9.b(var4);
