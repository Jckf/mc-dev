...
public class et extends ByteBuf {
   ...
   public dh b() {
      ...
      if(var1 < 0) {
         ...
         this.readBytes(var2);
         return du.a(var2, new ds(2097152L));
      }
   }
   ...
   public void a(add var1) {
      if(var1 == null) {
         ...
         this.writeShort(adb.b(var1.b()));
         this.writeByte(var1.b);
         this.writeShort(var1.k());
         dh var2 = null;
         if(var1.b().p() || var1.b().s()) {
            var2 = var1.d;
         }
   ...
   public add c() {
      ...
      if(var2 >= 0) {
         ...
         var1 = new add(adb.d(var2), var3, var4);
         var1.d = this.b();
      }
