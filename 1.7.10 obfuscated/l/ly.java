...
public class ly extends JComponent {
   ...
   public static void a(lt var0) {
      ...
      var2.addWindowListener(new lz(var0));
   }
   ...
   private JComponent c() {
      ...
      var4.addActionListener(new ma(this, var4));
      var2.addFocusListener(new mb(this));
      var1.add(var3, "Center");
      var1.add(var4, "South");
      var1.setBorder(new TitledBorder(new EtchedBorder(), "Log and chat"));
      Thread var5 = new Thread(new mc(this, var2, var3));
      var5.setDaemon(true);
      var5.start();
      return var1;
   }
   ...
   public void a(JTextArea var1, JScrollPane var2, String var3) {
      if(!SwingUtilities.isEventDispatchThread()) {
         SwingUtilities.invokeLater(new md(this, var1, var2, var3));
      } else {
