...
public class gu extends ft {
   ...
   public gu(double var1, double var3, double var5, float var7, List var8, azw var9) {
      this.a = var1;
      this.b = var3;
      this.c = var5;
      this.d = var7;
   ...
   public void a(et var1) {
      ...
      for(int var6 = 0; var6 < var2; ++var6) {
         ...
         this.e.add(new agt(var7, var8, var9));
      }
