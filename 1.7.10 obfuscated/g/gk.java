...
public class gk extends ft {
   ...
   public gk(int var1, short[] var2, apx var3) {
      this.b = new agu(var3.g, var3.h);
      this.d = var1;
      int var4 = 4 * var1;
      ...
      try {
         ...
         for(int var7 = 0; var7 < var1; ++var7) {
            ...
            var6.writeShort((short)((aji.b(var3.a(var8, var10, var9)) & 4095) << 4 | var3.c(var8, var10, var9) & 15));
         }
         ...
         a.error("Couldn\'t create bulk block update packet", (Throwable)var11);
         this.c = null;
      }
   ...
   public void a(et var1) {
      this.b = new agu(var1.readInt(), var1.readInt());
