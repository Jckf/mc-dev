...
public class nz {
   ...
   static List a(File var0, Map var1) {
   ...
   private static void a(MinecraftServer var0, Collection var1, ProfileLookupCallback var2) {
      String[] var3 = (String[])Iterators.toArray(Iterators.filter(var1.iterator(), (Predicate)(new oa())), String.class);
      if(var0.Y()) {
         var0.aw().findProfilesByNames(var3, Agent.MINECRAFT, var2);
      } else {
         String[] var4 = var3;
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            UUID var8 = yz.a(new GameProfile((UUID)null, var7));
      ...
      if(a.exists() && a.isFile()) {
         ...
         try {
            ...
            while(var3.hasNext()) {
               ...
               var1.a((ol)(new ny(var4, var6, var7, var8, var9)));
            }
   ...
   public static String a(String var0) {
      if(!qn.b(var0) && var0.length() <= 16) {
         MinecraftServer var1 = MinecraftServer.I();
         GameProfile var2 = var1.ax().a(var0);
         if(var2 != null && var2.getId() != null) {
            return var2.getId().toString();
         } else if(!var1.N() && var1.Y()) {
            ArrayList var3 = Lists.newArrayList();
            oe var4 = new oe(var1, var3);
            ...
            return yz.a(new GameProfile((UUID)null, var0)).toString();
         }
      } else {
         return var0;
      }
   ...
   public static boolean a(lt var0, lq var1) {
      File var2 = d(var1);
      ...
      if(var2.exists() && var2.isDirectory()) {
         ...
         try {
            ...
            of var15 = new of(var0, var3, var4, var2, var14);
   ...
   private static void b(File var0) {
      if(var0.exists()) {
         if(!var0.isDirectory()) {
            throw new oh("Can\'t create directory " + var0.getName() + " in world save directory.", (oa)null);
         }
      } else if(!var0.mkdirs()) {
         throw new oh("Can\'t create directory " + var0.getName() + " in world save directory.", (oa)null);
      }
   ...
   public static boolean a(lq var0) {
      boolean var1 = b(var0);
      var1 = var1 && c(var0);
      return var1;
   }

   private static boolean b(lq var0) {
      boolean var1 = false;
      if(b.exists() && b.isFile()) {
         var1 = true;
      }
   ...
   private static boolean c(lq var0) {
      File var1 = d(var0);
      if(var1.exists() && var1.isDirectory()) {
         String[] var2 = var1.list(new og());
         if(var2.length > 0) {
