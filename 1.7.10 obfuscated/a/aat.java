...
public class aat extends zs {
   ...
   public aat(yx var1, agm var2, ahb var3) {
      this.a = var2;
      this.g = var3;
      this.f = new aas(var1.d, var2);
      this.a(new aay(this.f, 0, 36, 53));
      this.a(new aay(this.f, 1, 62, 53));
      this.a((aay)(new aau(var1.d, var2, this.f, 2, 120, 53)));

      int var4;
      for(var4 = 0; var4 < 3; ++var4) {
         for(int var5 = 0; var5 < 9; ++var5) {
            this.a(new aay(var1, var5 + var4 * 9 + 9, 8 + var5 * 18, 84 + var4 * 18));
         }
      }
