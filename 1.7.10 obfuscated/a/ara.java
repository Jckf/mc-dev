...
public class ara implements apu {
   ...
   public void a(int var1, int var2, aji[] var3, ahu[] var4) {
      byte var5 = 2;
      int var6 = var5 + 1;
      byte var7 = 33;
      int var8 = var5 + 1;
   ...
   public void b(int var1, int var2, aji[] var3, ahu[] var4) {
      for(int var5 = 0; var5 < 16; ++var5) {
         for(int var6 = 0; var6 < 16; ++var6) {
            ...
            for(int var11 = 127; var11 >= 0; --var11) {
               ...
               aji var13 = var3[var12];
               if(var13 != null && var13.o() != awt.a) {
                  if(var13 == ajn.b) {
                     if(var8 == -1) {
                        if(var7 <= 0) {
                           var9 = null;
   ...
   public apx d(int var1, int var2) {
      ...
      aji[] var3 = new aji['\u8000'];
      this.o = this.m.v().b(this.o, var1 * 16, var2 * 16, 16, 16);
      this.a(var1, var2, var3, this.o);
      this.b(var1, var2, var3, this.o);
      apx var4 = new apx(this.m, var3, var1, var2);
      byte[] var5 = var4.m();

      for(int var6 = 0; var6 < var5.length; ++var6) {
         var5[var6] = (byte)this.o[var6].ay;
      }
   ...
   private double[] a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      for(int var14 = 0; var14 < var5; ++var14) {
         for(int var15 = 0; var15 < var7; ++var15) {
            ...
            float var22 = 100.0F - qh.c(var20 * var20 + var21 * var21) * 8.0F;
            if(var22 > 80.0F) {
               var22 = 80.0F;
            }
   ...
   public void a(apu var1, int var2, int var3) {
      ...
      int var4 = var2 * 16;
      int var5 = var3 * 16;
      ahu var6 = this.m.a(var4 + 16, var5 + 16);
      var6.a(this.m, this.m.s, var4, var5);
      akx.M = false;
   }
