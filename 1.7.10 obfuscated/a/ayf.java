...
public class ayf {
   ...
   public azw a(sa var1, int var2) {
      double var3 = (double)this.a[var2].a + (double)((int)(var1.M + 1.0F)) * 0.5D;
      double var5 = (double)this.a[var2].b;
      double var7 = (double)this.a[var2].c + (double)((int)(var1.M + 1.0F)) * 0.5D;
      return azw.a(var3, var5, var7);
   }

   public azw a(sa var1) {
      return this.a(var1, this.b);
   }

   public boolean a(ayf var1) {
      if(var1 == null) {
         return false;
