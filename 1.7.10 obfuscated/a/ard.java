...
public class ard extends arc {
      ...
      while(var6 >= 0) {
         ...
         if(var8 < 0.0F) {
            ...
            for(double var9 = 0.5D; var7 < var1; ++var7) {
               ...
               int var15 = qh.c(var11 * Math.sin(var13) + (double)this.d[0] + var9);
               int var16 = qh.c(var11 * Math.cos(var13) + (double)this.d[2] + var9);
   ...
   void a(int var1, int var2, int var3, float var4, byte var5, aji var6) {
      ...
      for(var11[var5] = var10[var5]; var12 <= var7; ++var12) {
         ...
         while(var13 <= var7) {
            ...
            if(var15 > (double)(var4 * var4)) {
               ...
               aji var14 = this.c.a(var11[0], var11[1], var11[2]);
   ...
   void a(int var1, int var2, int var3) {
      ...
      for(int var5 = var2 + this.n; var4 < var5; ++var4) {
         ...
         this.a(var1, var4, var3, var6, (byte)1, ajn.t);
      }

   }

   void a(int[] var1, int[] var2, aji var3) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            var14[var6] = qh.c((double)(var1[var6] + var15) + 0.5D);
            var14[var7] = qh.c((double)var1[var7] + (double)var15 * var10 + 0.5D);
            var14[var8] = qh.c((double)var1[var8] + (double)var15 * var12 + 0.5D);
            byte var17 = 0;
   ...
   int a(int[] var1, int[] var2) {
      ...
      if(var3[var5] == 0) {
         ...
         for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
            ...
            var13[var6] = qh.c((double)var1[var6] + (double)var14 * var9);
            var13[var7] = qh.c((double)var1[var7] + (double)var14 * var11);
            aji var16 = this.c.a(var13[0], var13[1], var13[2]);
            if(!this.a(var16)) {
               break;
            }
         }
   ...
   boolean e() {
      ...
      aji var3 = this.c.a(this.d[0], this.d[1] - 1, this.d[2]);
      if(var3 != ajn.d && var3 != ajn.c && var3 != ajn.ak) {
         return false;
      } else {
