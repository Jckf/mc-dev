...
public class aen {
   ...
   public static List b(int var0, boolean var1) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if(var6 != null && (!var6.i() || var1)) {
            String var7 = (String)n.get(Integer.valueOf(var6.c()));
            if(var7 != null) {
               int var8 = a(var7, 0, var7.length(), var0);
               if(var8 > 0) {
                  int var9 = 0;
                  String var10 = (String)o.get(Integer.valueOf(var6.c()));
                  if(var10 != null) {
                  ...
                  rw var11 = new rw(var6.c(), var8, var9);
                  if((var0 & 16384) != 0) {
                     var11.a(true);
                  }
   ...
   static {
      n.put(Integer.valueOf(rv.l.c()), "0 & !1 & !2 & !3 & 0+6");
      b = "-0+1-2-3&4-4+13";
      n.put(Integer.valueOf(rv.c.c()), "!0 & 1 & !2 & !3 & 1+6");
      h = "+0+1-2-3&4-4+13";
      n.put(Integer.valueOf(rv.n.c()), "0 & 1 & !2 & !3 & 0+6");
      f = "+0-1+2-3&4-4+13";
      n.put(Integer.valueOf(rv.h.c()), "0 & !1 & 2 & !3");
      d = "-0-1+2-3&4-4+13";
      n.put(Integer.valueOf(rv.u.c()), "!0 & !1 & 2 & !3 & 2+6");
      e = "-0+3-4+13";
      n.put(Integer.valueOf(rv.t.c()), "!0 & !1 & !2 & 3 & 3+6");
      n.put(Integer.valueOf(rv.i.c()), "!0 & !1 & 2 & 3");
      n.put(Integer.valueOf(rv.d.c()), "!0 & 1 & !2 & 3 & 3+6");
      g = "+0-1-2+3&4-4+13";
      n.put(Integer.valueOf(rv.g.c()), "0 & !1 & !2 & 3 & 3+6");
      l = "-0+1+2-3+13&4-4";
      n.put(Integer.valueOf(rv.r.c()), "!0 & 1 & 2 & !3 & 2+6");
      n.put(Integer.valueOf(rv.p.c()), "!0 & 1 & 2 & 3 & 2+6");
      m = "+0-1+2+3+13&4-4";
      n.put(Integer.valueOf(rv.o.c()), "0 & !1 & 2 & 3 & 2+6");
      j = "+5-6-7";
      o.put(Integer.valueOf(rv.c.c()), "5");
      o.put(Integer.valueOf(rv.e.c()), "5");
      o.put(Integer.valueOf(rv.g.c()), "5");
      o.put(Integer.valueOf(rv.l.c()), "5");
      o.put(Integer.valueOf(rv.i.c()), "5");
      o.put(Integer.valueOf(rv.h.c()), "5");
      o.put(Integer.valueOf(rv.m.c()), "5");
      o.put(Integer.valueOf(rv.u.c()), "5");
      i = "-5+6-7";
      k = "+14&13-13";
      p = new HashMap();
