...
public class aqh {
   ...
   public DataOutputStream b(int var1, int var2) {
      return this.d(var1, var2)?null:new DataOutputStream(new DeflaterOutputStream(new aqi(this, var1, var2)));
   }
   ...
   protected synchronized void a(int var1, int var2, byte[] var3, int var4) {
      try {
         ...
         this.b(var1, var2, (int)(MinecraftServer.ar() / 1000L));
