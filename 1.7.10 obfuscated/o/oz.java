   ...
   public void run() {
      while(true) {
         try {
            ...
            if(10 <= var2) {
               byte var3 = 0;
               int var4 = ou.b(this.k, 0, var2);
               if(var4 != var2 - 4) {
                  return;
               }

               int var21 = var3 + 4;
               int var5 = ou.b(this.k, var21, var2);
               var21 += 4;
               int var6 = ou.b(this.k, var21);
               var21 += 4;
               switch(var6) {
               case 2:
                  if(this.i) {
                     String var8 = ou.a(this.k, var21, var2);
                  ...
                  continue;
               case 3:
                  String var7 = ou.a(this.k, var21, var2);
