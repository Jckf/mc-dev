...
public abstract class z implements ac {
   ...
   public static dt a(ae var0, String[] var1, int var2, boolean var3) {
      dt var4 = var0.c();
   ...
   public static double c(String var0) {
      try {
   ...
   public static wv b(ae var0, String var1) {
   ...
   public static List c(ae var0, String var1) {
      return (List)(ah.b(var1)?ah.b(var0, var1, wv.class):Lists.newArrayList((Object[])(new wv[]{b(var0, var1)})));
   }

   public static String d(ae var0, String var1) {
      try {
   ...
   public static String e(ae var0, String var1) {
      try {
         return a(var0, var1).d_();
      } catch (dm var5) {
         try {
   ...
   public static ho a(ae var0, String[] var1, int var2) {
      return b(var0, var1, var2, false);
   }

   public static ho b(ae var0, String[] var1, int var2, boolean var3) {
      hy var4 = new hy("");
   ...
   public static aa a(double var0, String var2, boolean var3) {
      return a(var0, var2, -30000000, 30000000, var3);
   }

   public static aa a(double var0, String var2, int var3, int var4, boolean var5) {
   ...
   public static double b(double var0, String var2, int var3, int var4, boolean var5) {
      boolean var6 = var2.startsWith("~");
      if(var6 && Double.isNaN(var0)) {
         throw new dk("commands.generic.num.invalid", new Object[]{Double.valueOf(var0)});
      } else {
   ...
   public static alq f(ae var0, String var1) {
      oa var2 = new oa(var1);
   ...
   public static atr g(ae var0, String var1) {
      oa var2 = new oa(var1);
      if(!atr.c.d(var2)) {
         throw new dk("commands.give.notFound", new Object[]{var2});
      } else {
