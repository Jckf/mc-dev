...
public class cr extends z {
      ...
      if(var2.length < 6) {
         ...
         while(var17 < var2.length) {
            ...
            if(ah.b(var15)) {
               ...
               qw var18 = MinecraftServer.M().an().a(var15);
               if(var18 == null) {
                  throw new dm();
               }
   ...
   private void a(ae var1, List var2, cs var3, double var4, double var6, aqu var8, boolean var9) {
   ...
   private int a(cs var1, double var2, aqu var4, Random var5, double var6, double var8, double var10, double var12, cs[] var14, boolean var15) {
      boolean var16 = true;
