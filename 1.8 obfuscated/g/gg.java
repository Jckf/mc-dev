...
public class gg {
   ...
   public static fn a(String var0) {
      var0 = var0.trim();
      if(!var0.startsWith("{")) {
   ...
   static gh a(String ... var0) {
      return a(var0[0], var0[1]);
   }

   static gh a(String var0, String var1) {
      var1 = var1.trim();
      String var3;
      boolean var4;
      char var6;
   ...
   private static gh a(String var0, boolean var1) {
   ...
   private static String d(String var0, boolean var1) {
      if(var1) {
         var0 = var0.trim();
         if(var0.startsWith("{") || var0.startsWith("[")) {
            return var0;
