...
public class fz {
   ...
   public static fn a(InputStream var0) {
   ...
   public static void a(fn var0, OutputStream var1) {
   ...
   public static fn a(DataInputStream var0) {
      return a((DataInput)var0, fx.a);
   }

   public static fn a(DataInput var0, fx var1) {
   ...
   public static void a(fn var0, DataOutput var1) {
      a((gd)var0, var1);
   }

   private static void a(gd var0, DataOutput var1) {
   ...
   private static gd a(DataInput var0, int var1, fx var2) {
